function [new_matrix1, new_matrix2] = combine_point_clouds(matrix1, matrix2)
    ...
    % Reordering points following polar angles method
    % (Reordering is necessary if we want to apply any Landmark detection
    % algorithm)
